...
DiceTwoLabel::DiceTwoLabel(std::string text, std::string fontName, int fontSize, SDL_Color colour, glm::vec2 position, int fontStyle, bool isCentered) :
...
DiceTwoLabel::~DiceTwoLabel()
{

}

void DiceTwoLabel::draw()
{
...
void DiceTwoLabel::update()
{
}

void DiceTwoLabel::clean()
{

}

void DiceTwoLabel::setText(std::string newText)
{
...
void DiceTwoLabel::setColour(SDL_Color newColour)
{
	FontManager::Instance()->load(m_fontPath, m_fontID, m_fontSize, m_fontStyle);
	FontManager::Instance()->textToTexture(m_text, m_fontID, m_fontID, newColour);
}

void DiceTwoLabel::setSize(int newSize)
{
	m_fontSize = newSize;
...
void DiceTwoLabel::m_buildFontID()
{
	m_fontID = m_fontName;
	m_fontID += "-";
